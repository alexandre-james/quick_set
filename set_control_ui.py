...
class Ui_Sets(object):
    def setupUi(self, Sets):
        ...
        Sets.setMaximumSize(QtCore.QSize(500, 1000))
        ...
        self.auto_layout = QtWidgets.QHBoxLayout()
        self.auto_layout.setAlignment(QtCore.Qt.AlignCenter)
        self.b_auto = QtWidgets.QCheckBox(Sets)
        self.b_auto.setStyleSheet("border:none")
        self.b_auto.setText("")
        self.b_auto.setObjectName("b_auto")
        self.auto_layout.addWidget(self.b_auto)
        self.auto_label = QtWidgets.QLabel(Sets)
